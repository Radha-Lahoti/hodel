...
pinn_config = TrainConfig(hodel.Method.PINN, 10000)
hodel_config = TrainConfig(hodel.Method.HODEL, 50)
node_config = TrainConfig(hodel.Method.ODE, 10)
config_map = {
    "pinn": pinn_config,
    "hodel": hodel_config,
    "node": node_config,
...
if __name__ == "__main__":
    ...
    def train(key: jax.Array):
        sim, state0, xf0, params, get_aux = get_triplets(key=key)
    ...
    sim, state0, xf0, _, get_aux = get_triplets()  # ignore initial params
